...
//	private static final Logger LOGGER = LoggerFactory.getLogger(CommonPageStepDefinitions.class);
//
...
//		getDriver().get(webserviceEndpoint);
//		LOGGER.info(webserviceEndpoint);
//	}
//
//
//
